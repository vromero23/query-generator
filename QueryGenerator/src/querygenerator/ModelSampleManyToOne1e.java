...
public class ModelSampleManyToOne1e {
    ...
    public static MappingModel getModel() {
        ...
        docTypeDrives.addArrayField(new ArrayField ("data_Car", new SimpleField(docTypeDrives, "fObservation", "string", new FieldMapping(drives.getAttribute("observation")))));
